...
(* NOTE:  This module uses Obj,
but that's OK because this is DEBUGGING code.
Production code must NEVER use Obj. *)

let tag_name t = List.assoc t [
    lazy_tag, "lazy";
    closure_tag, "closure";
    object_tag, "object";
    infix_tag, "infix";
